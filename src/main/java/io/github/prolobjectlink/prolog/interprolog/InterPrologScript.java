...
class InterPrologScript extends AbstractProgram implements PrologProgram {

	InterPrologScript(PrologEngine engine) {
		super(engine);
	}

	public PrologClauses newClauses(String functor, int arity) {
		return new InterPrologClauses(functor, arity);
	}
